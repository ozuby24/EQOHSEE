...
@if($errors->any())
  {{-- Ringkasan galat ditaruh di atas formulir, bukan hanya di bawah tiap
       isian: pada formulir panjang, pesan yang jauh di bawah lipatan layar
       membuat orang mengira tombol simpannya yang rusak. --}}
