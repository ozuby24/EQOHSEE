          ...
          <table class="min-w-full text-left text-[12px]">
            ...
            <tbody>
              <tr v-for="item in props.tindak || []" :key="item.id" class="border-b border-stone-50" :class="item.terlambat ? 'bg-red-50/40' : ''">
                ...
                <td class="px-5 py-3">
                  <select :value="item.status" class="rounded border-stone-200 text-[11px]" @change="ubahTindak(item, ($event.target as HTMLSelectElement).value)" aria-label="Status">
