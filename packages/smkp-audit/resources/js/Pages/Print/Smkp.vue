...
import BlankLayout from '../../Layouts/SmkpBlankLayout.vue';
import PrintShell from '../../Components/SmkpPrintShell.vue';
import DocHeader from '../../Components/SmkpDocHeader.vue';
...
/*
  DocHeader dulu dirakit di sini sebagai komponen fungsional tiga sel. Kop
  dokumen terkendali menuntut lebih dari itu — nomor dokumen, tanggal terbit,
  tanggal persetujuan, revisi, divisi, departemen — sehingga bentuk lengkapnya
  pindah ke Components/SmkpDocHeader.vue dan diimpor pada <script setup> di
  atas. InfoAudit tetap di sini: ia hanya dipakai satu lembar laporan.
*/
...
export default { components: { InfoAudit } };
</script>
