...
use Eqohsee\SmkpAudit\Models\Concerns\MilikPerusahaan;
...
/**
 * Satu periode audit internal SMKP — satu perusahaan, satu tahun.
 *
 * Seluruh isian formulir disimpan sebagai JSON, bukan sebagai kolom
 * tersendiri. Bentuk formulirnya mengikuti acuan yang dapat berubah
 * (resources/data/elemen.json dan daftar pada SmkpTahap), sehingga menaruhnya
 * di kolom berarti bermigrasi tiap kali satu baris isian bertambah.
 */
class SmkpAudit extends Model
{
     ...
     *
     * Menunjuk model aplikasi induk bila disetel; bila tidak, menunjuk model
     * bayangan paket agar relasinya tetap berbentuk sah. Pada keadaan itu
     * controller tidak pernah memuatnya — lihat SmkpAudit::pakaiPerusahaan().
     */
    public function company(): BelongsTo
    {
        return $this->belongsTo(static::modelPerusahaan(), 'company_id');
    }

    public function user(): BelongsTo
    {
        return $this->belongsTo(static::modelPengguna());
    }

    public function findings(): HasMany
    {
        return $this->hasMany(SmkpFinding::class, 'audit_id');
    }
    ...
    public static function modelPerusahaan(): string
    {
        return (string) (config('smkp.model.perusahaan') ?: Perusahaan::class);
    }

    public static function modelPengguna(): string
    {
        return (string) (config('smkp.model.pengguna') ?: Pengguna::class);
    }
    ...
    public function statusAlur(): array
    {
        ...
        // bukan satu per satu — sebuah langkah selesai bila seluruh komponen
        // di bawahnya terisi.
