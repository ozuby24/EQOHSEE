...
class Company extends Model {
    protected $fillable = ['name','demo','code','parent','izin_type','commodity','location','address','ktt','pjo','workers_employee','workers_sub','risk_class','logo','theme_color','theme_dark','doc_no_prefix','parent_id','pic_name','pic_email','pic_phone','divisi','departemen','doc_terbit','doc_setuju','doc_revisi'];
