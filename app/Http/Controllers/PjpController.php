...
class PjpController extends Controller
{
    ...
    /**
     * Pengguna biasa tidak boleh menulis data atas nama perusahaan lain.
     *
     * Penyaringan di daftar saja tidak cukup: yang dikirim formulir dapat
     * menyebut company_id mana pun, dan barisnya akan lahir di sana tanpa
     * satu pun galat.
     */
