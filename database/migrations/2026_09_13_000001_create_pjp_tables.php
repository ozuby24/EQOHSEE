...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('pjps', function (Blueprint $t) {
            ...
            $t->string('status')->default('aktif')->index();
        ...
        Schema::create('pjp_laporans', function (Blueprint $t) {
            ...
            /*
             * Indeksnya memuat created_at, bukan hanya (pjp_id, jenis).
             * Pjp::belumLaporanBulananBulanIni() menyaring jenis lalu
             * rentang created_at untuk tiap PJP yang masih dipantau, dan
             * kueri itu berjalan pada SETIAP pembukaan beranda modul —
             * bukan sesekali saat laporan dicetak.
             */
